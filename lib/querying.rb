...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM characters JOIN series ON characters.author_id = series.author_id 
...
def select_character_names_and_number_of_books_they_are_in
  ...
  GROUP BY characters.name ORDER BY COUNT(characters.name) DESC, characters.name ASC;"
end
